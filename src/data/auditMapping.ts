export const auditMapping = {
    ...
    xmlSitemaps: "Does the site have an XML sitemap?",
    ...
    siteBlog: "Does the site have a blog?",
    blogUpdateFrequency: "Is the blog updated roughly once a month?",
    callsToAction: "Does the site have calls to action?",
    preferredSubdomain: "Subdomain Preference",
